 ...
 * @author AERONICS
 */
class AeronicsBuergel_CreditCheck_Model_Source_ProductsRiskCheck
    extends AeronicsBuergel_CreditCheck_Model_Source_AbstractSource
{
    /** @var array */
    protected $data = array(
        1 => 'RiskCheck RalTime standard',
        2 => 'RiskCheck RalTime advanced',
        3 => 'RiskCheck RalTime professional',
    );
}