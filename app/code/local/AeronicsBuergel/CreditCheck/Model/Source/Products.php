 ...
 * @author AERONICS
 */
class AeronicsBuergel_CreditCheck_Model_Source_Products
    extends AeronicsBuergel_CreditCheck_Model_Source_AbstractSource
{
    /** @var array */
    protected $data = array(
        1 => 'Buergel ConCheck for consumers',
        2 => 'Buergel ConCheck for consumers and Buergel RiskCheck for company',
        3 => 'Buergel RiskCheck for consumers and company',
    );
}